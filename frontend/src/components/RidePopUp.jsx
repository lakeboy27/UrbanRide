...
const RidePopUp = (props) => {
  return (
    <div>
        ...
        <button onClick={()=>{
                props.setRidePopupPanel(false) ;
            }} className='mt-1 bg-gray-300 text-gray-700 rounded-lg font-semibold p-3 px-14'>Ignore</button>

            <button onClick={()=>{
                props.setConfirmRidePopupPanel(true) ; 
            }} className=' bg-green-600 text-white rounded-lg font-semibold p-3 px-14 '>Accept</button>
